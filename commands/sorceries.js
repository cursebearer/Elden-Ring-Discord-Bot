    ...
    client.on('messageCreate', async (message) => {
        if (message.content.startsWith('!sorcerie ')) {
            ...
            try {
                ...
                // Verifica se o nome exato do feitiço foi passado como comando
                ...
                // Se não houver correspondência exata, continua com a pesquisa normal
...
function createSorcerieEmbed(sorcerie) {
    ...
    return new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: 'Cost: ', value: String(sorcerie.cost), inline: true }, // Convertido para string
            { name: 'Slots: ', value: String(sorcerie.slots), inline: true }, // Convertido para string
